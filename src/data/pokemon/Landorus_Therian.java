...
public class Landorus_Therian implements Pokemon
{
	Flying t1 = new Flying();
	Ground t2 = new Ground();
	...
	public ArrayList<TYPE> getType() {
		// TODO Auto-generated method stub
		return new ArrayList<TYPE>(Arrays.asList(TYPE.GROUND, TYPE.FLYING));
	}
